...
[RESOLVED 2026-07-23 — DO NOT RE-REPORT] The fabricated aggregateRating markup (4.9 with invented review counts) was REMOVED from both SEOHead.jsx and prerender.mjs on 2026-07-23. The crawler-facing pages no longer declare ratings. Never propose "remove the fake ratings" as a task — it is done. The live follow-up opportunity is the opposite: collect REAL customer reviews and re-add honest aggregateRating markup wired to real data.
