...
export const STYLES = ['boldpop', 'goldglow', 'cleanbox', 'popline', 'rosa', 'minimal', 'lujo', 'grande', 'resalta', 'brillo', 'sombra', 'fluido', 'palabra', 'pildora', 'heroe', 'temblor', 'escenario', 'mixto', 'contorno', 'bloque', 'subrayado', 'fiesta', 'editorial', 'corrido', 'craft', 'retro', 'brasa', 'impacto', 'neon', 'luxe', 'cine', 'grafica', 'revista', 'energia', 'historia'];
