...
export default function WhatsAppButton() {
  ...
  // Show tooltip after 5 seconds, auto-hide after 8 more
  React.useEffect(() => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex items-end gap-3">
      ...
      <button
        onClick={handleClick}
        className="group w-[60px] h-[60px] bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 hover:bg-[#20bd5a]"
      ...
      >
        ...
        {/* Pulse ring */}
        <span className="absolute w-[60px] h-[60px] rounded-full bg-[#25D366] animate-ping opacity-20"></span>
      </button>
