...
export const DEFAULT_GENRE_FAQS = [
  {
    ...
    answer: 'Tu canción personalizada estará lista en solo 2-4 minutos. Generamos dos versiones únicas para que elijas tu favorita o te quedes con ambas.'
  },
  {
...
export const DEFAULT_OCCASION_FAQS = [
  {
    question: '¿Cuánto tiempo tarda en crearse la canción?',
    answer: 'Tu canción estará lista en solo 2-4 minutos. Generamos dos versiones únicas para que elijas tu favorita.'
  },
  {
    question: '¿Puedo escuchar la canción antes de pagar?',
...
export const GENRES_SEO = {
  'corridos-tumbados': {
    ...
    metaDescription: 'Crea un corrido tumbado personalizado único. Estilo Peso Pluma, Junior H, Natanael Cano. Letra con el nombre de tu ser querido. Listo en minutos desde $24.99.',
    ...
    description: 'Crea un corrido tumbado único y personalizado. Incluye el nombre de tu ser querido, menciona sus logros, y sorpréndelos con el género más popular del momento.',
    definitionBlock: 'Un corrido tumbado personalizado es una canción original que fusiona corrido mexicano con trap y hip-hop, creada exclusivamente para incluir el nombre y la historia de tu ser querido. Con el flow de artistas como Peso Pluma y Junior H, es un regalo único listo en minutos desde $24.99.',
...
Ahora puedes regalar un corrido tumbado completamente personalizado. Creamos letras únicas que mencionan el nombre de tu ser querido, sus características especiales, y la ocasión que celebras. El resultado es una canción profesional que suena como si fuera de tus artistas favoritos.
...
Perfecto para cumpleaños, graduaciones, o simplemente para sorprender a alguien especial con un regalo que nunca olvidarán.`,
    ...
    faqs: [
      ...
      { question: '¿Puedo elegir el estilo de artista para mi corrido tumbado?', answer: 'Sí, puedes crear corridos tumbados inspirados en el estilo de artistas como Peso Pluma, Natanael Cano, Junior H o Fuerza Regida. Tú eliges el vibe.' },
  ...
  'corrido-clasico': {
    ...
    metaDescription: 'Crea un corrido clásico tradicional personalizado. Estilo Los Tigres del Norte, Los Tucanes. Historia de vida en canción. Desde $24.99.',
    ...
    definitionBlock: 'Un corrido clásico personalizado es una canción narrativa en el estilo tradicional del corrido mexicano, creada exclusivamente para contar la historia de vida de tu ser querido. Con acordeón, bajo sexto y guitarra, narra sus logros y hazañas como las grandes canciones de Los Tigres del Norte.',
...
Con RegalosQueCantan, puedes crear un corrido clásico que cuente la historia de alguien especial. Ya sea su trayectoria de vida, sus logros, o simplemente lo mucho que significa para ti, creamos letras narrativas en el estilo tradicional del corrido.`,
  ...
  'banda-sinaloense': {
    ...
    metaDescription: 'Crea una canción de banda sinaloense personalizada. Estilo Banda MS, El Recodo, Julión Álvarez. Con metales, tuba y nombre personalizado. Desde $24.99.',
    ...
    definitionBlock: 'Una canción de banda sinaloense personalizada es una pieza musical original con metales, tuba y clarinete, creada exclusivamente e inspirada en el sonido de Banda MS y El Recodo. Incluye el nombre de tu ser querido y un mensaje especial, perfecta para bodas, quinceañeras y fiestas.',
...
Tu canción personalizada incluirá el nombre de tu ser querido, un mensaje especial, y todo el poder musical de la banda sinaloense. Perfecta para bodas, quinceañeras, cumpleaños y cualquier celebración que merezca música en grande.`,
  ...
  'norteno': {
    ...
    name: 'Norteño',
    slug: 'norteno',
    title: 'Música Norteña Personalizada',
    metaDescription: 'Crea una canción norteña personalizada con acordeón y bajo sexto. Estilo Intocable, Ramón Ayala, Pesado. Regalo único desde $24.99.',
    ...
    definitionBlock: 'Una canción norteña personalizada es una pieza original con acordeón y bajo sexto creada exclusivamente, inspirada en artistas como Intocable y Ramón Ayala. Incluye el nombre de tu ser querido y un mensaje personal, capturando la esencia romántica y emotiva del norte de México.',
...
Crea una canción norteña personalizada que incluya el nombre de tu ser querido y un mensaje especial. Ya sea una canción de amor, de amistad, o de celebración, capturamos la esencia del género norteño.`,
  ...
  'cumbia': {
    ...
    name: 'Cumbia',
    slug: 'cumbia',
    title: 'Cumbia Personalizada',
    metaDescription: 'Crea una cumbia personalizada. Ritmo contagioso, güiro y acordeón. Perfecta para fiestas y celebraciones. Desde $24.99.',
    ...
    definitionBlock: 'Una cumbia personalizada es una canción bailable creada exclusivamente que incluye el nombre de tu ser querido y un mensaje especial. Con güiro, teclados y el ritmo contagioso que une a toda Latinoamérica, es el regalo perfecto para fiestas, cumpleaños y celebraciones familiares.',
...
Tu cumbia personalizada incluirá el nombre de tu ser querido, un mensaje especial, y ese ritmo contagioso que no deja a nadie quieto. Perfecta para cualquier celebración donde quieras que todos bailen y celebren.`,
  ...
  'cumbia-nortena': {
    ...
    metaDescription: 'Crea una cumbia norteña con acordeón personalizada. Estilo Grupo Pesado, Bronco. Ritmo norteño con tu mensaje. Desde $24.99.',
    ...
    definitionBlock: 'La cumbia norteña personalizada combina el ritmo de la cumbia con el acordeón y bajo sexto del norte de México. Creada exclusivamente al estilo de Bronco y Grupo Pesado, incluye el nombre de tu ser querido para un regalo musical que pone a bailar a toda la familia.',
  ...
  'cumbia-colombiana': {
    ...
    metaDescription: 'Crea una cumbia colombiana tradicional personalizada. El ritmo original de Colombia con tu mensaje especial. Desde $24.99.',
  ...
  'cumbia-texana': {
    ...
    metaDescription: 'Crea una cumbia texana personalizada. El sonido de Texas con teclados y ritmo único. Desde $24.99.',
  ...
  'mariachi': {
    ...
    name: 'Mariachi',
    slug: 'mariachi',
    title: 'Mariachi Personalizado',
    metaDescription: 'Crea una canción de mariachi personalizada. Trompetas, violines y guitarrón con el nombre de tu ser querido. Serenata perfecta desde $24.99.',
    ...
    definitionBlock: 'Un mariachi personalizado es una canción original con trompetas, violines y guitarrón, creada exclusivamente para incluir el nombre de tu ser querido. Inspirada en la tradición de Vicente Fernández y Pedro Infante, es la serenata digital perfecta para el Día de las Madres, aniversarios y declaraciones de amor.',
...
Una serenata de mariachi es el regalo más romántico y tradicional. Con RegalosQueCantan, puedes crear una canción de mariachi personalizada que incluya el nombre de tu amor, un mensaje especial, y toda la emoción del género.`,
    ...
    faqs: [
      ...
      { question: '¿Suena como un mariachi real?', answer: 'Sí, generamos música con trompetas, violines y guitarrón que captura la esencia del mariachi tradicional. La producción es de calidad profesional.' },
      ...DEFAULT_GENRE_FAQS
    ]
  },
  ...
  'bachata': {
    ...
    name: 'Bachata',
    slug: 'bachata',
    title: 'Bachata Personalizada',
    metaDescription: 'Crea una bachata romántica personalizada. Estilo Romeo Santos, Prince Royce. Guitarra y ritmo sensual con tu mensaje de amor. Desde $24.99.',
    ...
    definitionBlock: 'Una bachata personalizada es una canción romántica original con guitarra requinteada y bongos, creada exclusivamente al estilo de Romeo Santos y Prince Royce. Incluye el nombre de tu persona especial y un mensaje de amor único, perfecta para San Valentín, aniversarios y declaraciones de amor. Lista en minutos desde $24.99.',
...
Una bachata personalizada es el regalo perfecto para esa persona especial. Incluye su nombre, menciona momentos especiales de su relación, y créale una canción de amor que nunca olvidará.`,
  ...
  'reggaeton': {
    ...
    name: 'Reggaeton',
    slug: 'reggaeton',
    title: 'Reggaeton Personalizado',
    metaDescription: 'Crea un reggaeton personalizado. Perreo, dembow y letras únicas con el nombre de tu persona especial. Desde $24.99.',
    ...
    definitionBlock: 'Un reggaeton personalizado es una canción urbana original con dembow y beats de perreo, creada exclusivamente al estilo de Bad Bunny y Daddy Yankee. Incluye el nombre de tu persona especial con letras únicas, ideal para cumpleaños, fiestas y despedidas. Lista en minutos desde $24.99.',
  ...
  'salsa': {
    ...
    name: 'Salsa',
    slug: 'salsa',
    title: 'Salsa Personalizada',
    metaDescription: 'Crea una salsa personalizada. Trompetas, piano y sabor caribeño. Estilo Marc Anthony, Héctor Lavoe. Desde $24.99.',
    ...
    definitionBlock: 'Una salsa personalizada es una canción caribeña original con trompetas, piano y timbales, creada exclusivamente al estilo de Marc Anthony y Héctor Lavoe. Incluye el nombre de tu ser querido y un mensaje especial, perfecta para bodas, aniversarios y fiestas. Lista en minutos desde $24.99.',
  ...
  'bolero': {
    ...
    metaDescription: 'Crea un bolero romántico personalizado. El género más romántico con guitarras y letras poéticas. Desde $24.99.',
    ...
    definitionBlock: 'Un bolero personalizado es una canción romántica clásica con guitarras suaves y voces aterciopeladas, creada exclusivamente al estilo de Luis Miguel y Trío Los Panchos. Incluye el nombre de tu ser querido con letras poéticas de amor, ideal para aniversarios, Día de las Madres y San Valentín. Desde $24.99.',
  ...
  'ranchera': {
    ...
    name: 'Ranchera',
    slug: 'ranchera',
    title: 'Ranchera Personalizada',
    metaDescription: 'Crea una ranchera personalizada. El género tradicional mexicano con mariachi. Estilo José Alfredo Jiménez. Desde $24.99.',
    ...
    definitionBlock: 'Una ranchera personalizada es una canción mexicana tradicional creada exclusivamente al estilo de José Alfredo Jiménez y Pedro Infante. Con mariachi, guitarra y sentimiento mexicano, incluye el nombre de tu ser querido y un mensaje de amor, orgullo o gratitud. Perfecta para el Día de las Madres y fiestas patrias. Desde $24.99.',
  ...
  'regional-mexicano': {
    ...
    metaDescription: 'Crea una canción de regional mexicano personalizada. Mezcla de géneros tradicionales mexicanos. Desde $24.99.',
    ...
    definitionBlock: 'Una canción de regional mexicano personalizada fusiona los mejores estilos de la música mexicana — norteño, banda y sierreño — creada exclusivamente al estilo de Christian Nodal y Calibre 50. Incluye el nombre de tu ser querido, perfecta para cualquier celebración familiar. Lista en minutos desde $24.99.',
  ...
  'pop-latino': {
    ...
    metaDescription: 'Crea una canción de pop latino personalizada. Estilo Luis Fonsi, Shakira. Moderno y pegajoso. Desde $24.99.',
    ...
    definitionBlock: 'Una canción de pop latino personalizada combina ritmos latinos con producción moderna, creada exclusivamente al estilo de Shakira y Luis Fonsi. Pegajosa y bailable, incluye el nombre de tu ser querido con un mensaje especial. Ideal para cumpleaños, graduaciones y quinceañeras. Desde $24.99.',
  ...
  'balada': {
    ...
    metaDescription: 'Crea una balada romántica personalizada. Letras emotivas y melodías que llegan al corazón. Desde $24.99.',
  ...
  'vallenato': {
    ...
    name: 'Vallenato',
    slug: 'vallenato',
    title: 'Vallenato Personalizado',
    metaDescription: 'Crea un vallenato personalizado. Acordeón, caja y guacharaca. El sonido de Colombia con tu mensaje. Desde $24.99.',
    ...
    definitionBlock: 'Un vallenato personalizado es una canción colombiana original con acordeón, caja y guacharaca, creada exclusivamente al estilo de Carlos Vives y Diomedes Díaz. Incluye el nombre de tu ser querido y cuenta tu historia de amor con el sabor auténtico de Colombia. Ideal para declaraciones y cumpleaños. Desde $24.99.',
  ...
  'merengue': {
    ...
    name: 'Merengue',
    slug: 'merengue',
    title: 'Merengue Personalizado',
    metaDescription: 'Crea un merengue personalizado. El ritmo más rápido y alegre del Caribe con tu mensaje especial. Desde $24.99.',
    ...
    definitionBlock: 'Un merengue personalizado es una canción dominicana rápida y alegre con acordeón, güira y tambora, creada exclusivamente al estilo de Juan Luis Guerra y Los Hermanos Rosario. Incluye el nombre de tu ser querido para una celebración llena de energía. Perfecta para fiestas y cumpleaños. Desde $24.99.',
  ...
  'huapango': {
    ...
    metaDescription: 'Crea un huapango personalizado. El son huasteco con violín, jarana y guitarra quinta. Tradición mexicana. Desde $24.99.',
    ...
    definitionBlock: 'Un huapango personalizado es una canción del son huasteco con violín, jarana y guitarra quinta, creada exclusivamente honrando la tradición de la Huasteca mexicana. Incluye el nombre de tu ser querido en un regalo musical auténtico, perfecto para fiestas tradicionales, bodas y homenajes culturales. Desde $24.99.',
  ...
  'son-jarocho': {
    ...
    metaDescription: 'Crea un son jarocho personalizado. La música tradicional de Veracruz con arpa, jarana y requinto. Desde $24.99.',
    ...
    definitionBlock: 'Un son jarocho personalizado es una canción veracruzana original con arpa, jarana y requinto, creada exclusivamente en la tradición del fandango. Incluye el nombre de tu ser querido para un regalo musical que celebra la cultura de Veracruz. Ideal para bodas, fiestas y celebraciones culturales. Desde $24.99.',
...
export const OCCASIONS_SEO = {
  'cumpleanos': {
    ...
    metaDescription: 'Regala una canción de cumpleaños única con el nombre del festejado. Más especial que "Las Mañanitas". En corridos, cumbia, banda y más géneros. Desde $24.99.',
    ...
    definitionBlock: 'Una canción de cumpleaños personalizada es un regalo musical original creado exclusivamente que incluye el nombre del festejado, su edad y detalles especiales. Disponible en cumbia, banda, corridos tumbados y más géneros latinos, es mucho más especial que "Las Mañanitas" genéricas. Lista en minutos desde $24.99.',
...
Imagina la cara de sorpresa cuando escuchen su nombre en una canción profesional. Es el regalo que nunca olvidarán.`,
  ...
  'dia-de-las-madres': {
    ...
    metaDescription: 'Regala a mamá una canción personalizada este 10 de Mayo. Con su nombre y todo tu amor. En mariachi, bolero, ranchera o el género que ella prefiera. Desde $24.99.',
    ...
    definitionBlock: 'Una canción para el Día de las Madres personalizada es un regalo musical creado exclusivamente que incluye el nombre de mamá y un mensaje de amor único. Disponible en mariachi, bolero, ranchera y más géneros, es el regalo perfecto para el 10 de Mayo que mamá nunca olvidará. Lista en minutos desde $24.99.',
...
Ya sea mariachi tradicional, bolero romántico, o el género que ella prefiera, creamos la canción perfecta para tu mamá.`,
  ...
  'dia-del-padre': {
    ...
    metaDescription: 'Sorprende a papá con una canción personalizada. Corrido, norteño o banda con su nombre y tu agradecimiento. El regalo perfecto. Desde $24.99.',
    ...
    definitionBlock: 'Una canción para el Día del Padre personalizada es un regalo musical creado exclusivamente que menciona el nombre de papá, sus logros y tu agradecimiento. En corrido, norteño, banda o el género que él prefiera, es la sorpresa que papá nunca esperaría. Lista en minutos desde $24.99.',
...
Crea un corrido que cuente sus logros, una ranchera que exprese tu admiración, o una banda que lo haga sonreír. El género que él prefiera, con su nombre y un mensaje de tu corazón.`,
  ...
  'aniversario': {
    ...
    metaDescription: 'Celebra su aniversario con una canción única. Romance, memorias y promesas de amor en bachata, bolero o el género que prefieran. Desde $24.99.',
    ...
    definitionBlock: 'Una canción de aniversario personalizada es un regalo romántico creado exclusivamente que cuenta la historia de amor de la pareja. Incluye los nombres de ambos, cómo se conocieron y promesas de amor, en bachata, bolero o el género que defina su relación. Lista en minutos desde $24.99.',
...
En bachata romántica, bolero clásico, o el género que marque su relación.`,
  ...
  'boda': {
    ...
    metaDescription: 'Haz su boda inolvidable con una canción personalizada. Primer baile único con sus nombres y historia de amor. Desde $24.99.',
    ...
    definitionBlock: 'Una canción de boda personalizada es una pieza musical única creada exclusivamente para el primer baile de los novios. Incluye los nombres de la pareja y su historia de amor, en bachata, bolero, cumbia o vals. Es el primer baile que ninguna otra pareja tendrá. Lista en minutos desde $24.99.',
...
Ya sea un vals romántico, una cumbia para que todos bailen, o una bachata sensual — la canción será solo suya.`,
  ...
  'quinceanera': {
    ...
    metaDescription: 'Haz sus XV años inolvidables con una canción personalizada. Vals único con su nombre. El regalo perfecto para la quinceañera. Desde $24.99.',
    ...
    definitionBlock: 'Una canción de quinceañera personalizada es un vals único creado exclusivamente que incluye el nombre de la festejada y deseos especiales para su nueva etapa. Disponible en balada, bachata, cumbia o mariachi, es el regalo perfecto para los XV años que ella nunca olvidará. Desde $24.99.',
...
Puede ser un vals tradicional, una cumbia para después, o incluso un reggaeton para la fiesta. Todo personalizado para ella.`,
  ...
  'graduacion': {
    ...
    metaDescription: 'Celebra su graduación con una canción que reconozca su esfuerzo. Con su nombre, carrera y logros. Regalo único desde $24.99.',
    ...
    definitionBlock: 'Una canción de graduación personalizada es un regalo musical creado exclusivamente que celebra los logros del graduado. Incluye su nombre, carrera y un mensaje de orgullo, en corridos tumbados, cumbia, pop latino o banda. El reconocimiento que su esfuerzo merece, listo en minutos desde $24.99.',
    icon: '🎓',
    color: '#1D4ED8',
  ...
  'san-valentin': {
    ...
    metaDescription: 'Regala la canción de amor perfecta este 14 de febrero. Bachata, bolero o balada personalizada con sus nombres. Desde $24.99.',
    ...
    definitionBlock: 'Una canción de San Valentín personalizada es el regalo romántico perfecto para el 14 de febrero, creado exclusivamente. Incluye los nombres de la pareja y un mensaje de amor único, en bachata, bolero o balada. Más especial que flores o chocolates, lista en minutos desde $24.99.',
    icon: '❤️',
    color: '#E11D48',
  ...
  'navidad': {
    ...
    metaDescription: 'Regala una canción navideña personalizada con los nombres de toda la familia. El villancico único para esta Navidad. Desde $24.99.',
    ...
    definitionBlock: 'Una canción navideña personalizada es un villancico único creado exclusivamente que menciona los nombres de toda la familia. En cumbia, pop latino, mariachi o balada, es el regalo de Navidad que guardarán para siempre y podrán escuchar cada diciembre. Desde $24.99.',
    icon: '🎄',
    color: '#15803D',
  ...
  'declaracion-amor': {
    ...
    metaDescription: 'Declara tu amor con una canción única. Bachata, bolero o balada con tu mensaje y el nombre de esa persona especial. Desde $24.99.',
    ...
    definitionBlock: 'Una canción para declarar tu amor es una pieza musical romántica creada exclusivamente que expresa tus sentimientos con el nombre de esa persona especial. En bachata, bolero, balada o mariachi, dice todo lo que tu corazón no puede expresar. Lista en minutos desde $24.99.',
    icon: '💌',
    color: '#DB2777',
  ...
  'despedida': {
    ...
    metaDescription: 'Despídete con una canción que exprese todo lo que no puedes decir. Para jubilaciones, mudanzas o adioses. Desde $24.99.',
    ...
    definitionBlock: 'Una canción de despedida personalizada es un regalo musical emotivo creado exclusivamente que expresa todo lo que esa persona significa para ti. Para jubilaciones, mudanzas o adioses, en bolero, balada o norteño, incluye su nombre y un mensaje del corazón. Desde $24.99.',
    icon: '👋',
    color: '#64748B',
  ...
  'agradecimiento': {
    ...
    metaDescription: 'Da las gracias de forma inolvidable con una canción personalizada. Para maestros, mentores o cualquier persona especial. Desde $24.99.',
    ...
    definitionBlock: 'Una canción de agradecimiento personalizada es un regalo musical creado exclusivamente que expresa tu gratitud de forma inolvidable. Incluye el nombre de esa persona especial — maestro, mentor o amigo — y un mensaje de agradecimiento en bolero, balada, mariachi o cumbia. Desde $24.99.',
    icon: '🙏',
    color: '#0891B2',
