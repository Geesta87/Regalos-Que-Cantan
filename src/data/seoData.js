...
export const GENRES_SEO = {
  'corridos-tumbados': {
    ...
    metaDescription: 'Crea un corrido tumbado personalizado único con IA. Estilo Peso Pluma, Junior H, Natanael Cano. Letra con el nombre de tu ser querido. Listo en minutos desde $24.99.',
    ...
    definitionBlock: 'Un corrido tumbado personalizado es una canción original que fusiona corrido mexicano con trap y hip-hop, creada con IA para incluir el nombre y la historia de tu ser querido. Con el flow de artistas como Peso Pluma y Junior H, es un regalo único listo en minutos desde $24.99.',
...
Perfecto para cumpleaños, graduaciones, o simplemente para sorprender a alguien especial con un regalo que nunca olvidarán.`,
  ...
  'corrido-clasico': {
    ...
    metaDescription: 'Crea un corrido clásico tradicional personalizado con IA. Estilo Los Tigres del Norte, Los Tucanes. Historia de vida en canción. Desde $24.99.',
...
Con RegalosQueCantan, puedes crear un corrido clásico que cuente la historia de alguien especial. Ya sea su trayectoria de vida, sus logros, o simplemente lo mucho que significa para ti, nuestra IA crea letras narrativas en el estilo tradicional del corrido.`,
  ...
  'banda-sinaloense': {
    ...
    metaDescription: 'Crea una canción de banda sinaloense personalizada con IA. Estilo Banda MS, El Recodo, Julión Álvarez. Con metales, tuba y nombre personalizado. Desde $24.99.',
...
Crea una canción norteña personalizada que incluya el nombre de tu ser querido y un mensaje especial. Ya sea una canción de amor, de amistad, o de celebración, nuestra IA captura la esencia del género norteño.`,
  ...
  'cumbia': {
    ...
    metaDescription: 'Crea una cumbia personalizada con IA. Ritmo contagioso, güiro y acordeón. Perfecta para fiestas y celebraciones. Desde $24.99.',
...
Tu cumbia personalizada incluirá el nombre de tu ser querido, un mensaje especial, y ese ritmo contagioso que no deja a nadie quieto. Perfecta para cualquier celebración donde quieras que todos bailen y celebren.`,
  ...
  'cumbia-colombiana': {
    ...
    metaDescription: 'Crea una cumbia colombiana tradicional personalizada con IA. El ritmo original de Colombia con tu mensaje especial. Desde $24.99.',
  ...
  'cumbia-texana': {
    ...
    metaDescription: 'Crea una cumbia texana personalizada con IA. El sonido de Texas con teclados y ritmo único. Desde $24.99.',
  ...
  'mariachi': {
    ...
    metaDescription: 'Crea una canción de mariachi personalizada con IA. Trompetas, violines y guitarrón con el nombre de tu ser querido. Serenata perfecta desde $24.99.',
...
Una serenata de mariachi es el regalo más romántico y tradicional. Con RegalosQueCantan, puedes crear una canción de mariachi personalizada que incluya el nombre de tu amor, un mensaje especial, y toda la emoción del género.`,
  ...
  'bachata': {
    ...
    metaDescription: 'Crea una bachata romántica personalizada con IA. Estilo Romeo Santos, Prince Royce. Guitarra y ritmo sensual con tu mensaje de amor. Desde $24.99.',
...
Una bachata personalizada es el regalo perfecto para esa persona especial. Incluye su nombre, menciona momentos especiales de su relación, y créale una canción de amor que nunca olvidará.`,
  ...
  'reggaeton': {
    ...
    metaDescription: 'Crea un reggaeton personalizado con IA. Perreo, dembow y letras únicas con el nombre de tu persona especial. Desde $24.99.',
    ...
    definitionBlock: 'Un reggaeton personalizado es una canción urbana original con dembow y beats de perreo, creada con IA al estilo de Bad Bunny y Daddy Yankee. Incluye el nombre de tu persona especial con letras únicas, ideal para cumpleaños, fiestas y despedidas. Lista en minutos desde $24.99.',
  ...
  'salsa': {
    ...
    metaDescription: 'Crea una salsa personalizada con IA. Trompetas, piano y sabor caribeño. Estilo Marc Anthony, Héctor Lavoe. Desde $24.99.',
    ...
    definitionBlock: 'Una salsa personalizada es una canción caribeña original con trompetas, piano y timbales, creada con IA al estilo de Marc Anthony y Héctor Lavoe. Incluye el nombre de tu ser querido y un mensaje especial, perfecta para bodas, aniversarios y fiestas. Lista en minutos desde $24.99.',
  ...
  'bolero': {
    ...
    metaDescription: 'Crea un bolero romántico personalizado con IA. El género más romántico con guitarras y letras poéticas. Desde $24.99.',
  ...
  'ranchera': {
    ...
    metaDescription: 'Crea una ranchera personalizada con IA. El género tradicional mexicano con mariachi. Estilo José Alfredo Jiménez. Desde $24.99.',
    ...
    definitionBlock: 'Una ranchera personalizada es una canción mexicana tradicional creada con IA al estilo de José Alfredo Jiménez y Pedro Infante. Con mariachi, guitarra y sentimiento mexicano, incluye el nombre de tu ser querido y un mensaje de amor, orgullo o gratitud. Perfecta para el Día de las Madres y fiestas patrias. Desde $24.99.',
  ...
  'regional-mexicano': {
    ...
    metaDescription: 'Crea una canción de regional mexicano personalizada con IA. Mezcla de géneros tradicionales mexicanos. Desde $24.99.',
    ...
    definitionBlock: 'Una canción de regional mexicano personalizada fusiona los mejores estilos de la música mexicana — norteño, banda y sierreño — creada con IA al estilo de Christian Nodal y Calibre 50. Incluye el nombre de tu ser querido, perfecta para cualquier celebración familiar. Lista en minutos desde $24.99.',
  ...
  'pop-latino': {
    ...
    metaDescription: 'Crea una canción de pop latino personalizada con IA. Estilo Luis Fonsi, Shakira. Moderno y pegajoso. Desde $24.99.',
    ...
    definitionBlock: 'Una canción de pop latino personalizada combina ritmos latinos con producción moderna, creada con IA al estilo de Shakira y Luis Fonsi. Pegajosa y bailable, incluye el nombre de tu ser querido con un mensaje especial. Ideal para cumpleaños, graduaciones y quinceañeras. Desde $24.99.',
  ...
  'balada': {
    ...
    metaDescription: 'Crea una balada romántica personalizada con IA. Letras emotivas y melodías que llegan al corazón. Desde $24.99.',
  ...
  'vallenato': {
    ...
    metaDescription: 'Crea un vallenato personalizado con IA. Acordeón, caja y guacharaca. El sonido de Colombia con tu mensaje. Desde $24.99.',
    ...
    definitionBlock: 'Un vallenato personalizado es una canción colombiana original con acordeón, caja y guacharaca, creada con IA al estilo de Carlos Vives y Diomedes Díaz. Incluye el nombre de tu ser querido y cuenta tu historia de amor con el sabor auténtico de Colombia. Ideal para declaraciones y cumpleaños. Desde $24.99.',
  ...
  'merengue': {
    ...
    metaDescription: 'Crea un merengue personalizado con IA. El ritmo más rápido y alegre del Caribe con tu mensaje especial. Desde $24.99.',
    ...
    definitionBlock: 'Un merengue personalizado es una canción dominicana rápida y alegre con acordeón, güira y tambora, creada con IA al estilo de Juan Luis Guerra y Los Hermanos Rosario. Incluye el nombre de tu ser querido para una celebración llena de energía. Perfecta para fiestas y cumpleaños. Desde $24.99.',
  ...
  'huapango': {
    ...
    metaDescription: 'Crea un huapango personalizado con IA. El son huasteco con violín, jarana y guitarra quinta. Tradición mexicana. Desde $24.99.',
  ...
  'son-jarocho': {
    ...
    metaDescription: 'Crea un son jarocho personalizado con IA. La música tradicional de Veracruz con arpa, jarana y requinto. Desde $24.99.',
...
Ya sea mariachi tradicional, bolero romántico, o el género que ella prefiera, creamos la canción perfecta para tu mamá.`,
  ...
  'dia-del-padre': {
    ...
    definitionBlock: 'Una canción para el Día del Padre personalizada es un regalo musical creado con IA que menciona el nombre de papá, sus logros y tu agradecimiento. En corrido, norteño, banda o el género que él prefiera, es la sorpresa que papá nunca esperaría. Lista en minutos desde $24.99.',
...
Crea un corrido que cuente sus logros, una ranchera que exprese tu admiración, o una banda que lo haga sonreír. El género que él prefiera, con su nombre y un mensaje de tu corazón.`,
  ...
  'aniversario': {
    ...
    definitionBlock: 'Una canción de aniversario personalizada es un regalo romántico creado con IA que cuenta la historia de amor de la pareja. Incluye los nombres de ambos, cómo se conocieron y promesas de amor, en bachata, bolero o el género que defina su relación. Lista en minutos desde $24.99.',
...
En bachata romántica, bolero clásico, o el género que marque su relación.`,
  ...
  'boda': {
    ...
    definitionBlock: 'Una canción de boda personalizada es una pieza musical única creada con IA para el primer baile de los novios. Incluye los nombres de la pareja y su historia de amor, en bachata, bolero, cumbia o vals. Es el primer baile que ninguna otra pareja tendrá. Lista en minutos desde $24.99.',
...
Ya sea un vals romántico, una cumbia para que todos bailen, o una bachata sensual — la canción será solo suya.`,
  ...
  'quinceanera': {
    ...
    definitionBlock: 'Una canción de quinceañera personalizada es un vals único creado con IA que incluye el nombre de la festejada y deseos especiales para su nueva etapa. Disponible en balada, bachata, cumbia o mariachi, es el regalo perfecto para los XV años que ella nunca olvidará. Desde $24.99.',
...
Puede ser un vals tradicional, una cumbia para después, o incluso un reggaeton para la fiesta. Todo personalizado para ella.`,
  ...
  'graduacion': {
    ...
    definitionBlock: 'Una canción de graduación personalizada es un regalo musical creado con IA que celebra los logros del graduado. Incluye su nombre, carrera y un mensaje de orgullo, en corridos tumbados, cumbia, pop latino o banda. El reconocimiento que su esfuerzo merece, listo en minutos desde $24.99.',
    icon: '🎓',
    color: '#1D4ED8',
  ...
  'san-valentin': {
    ...
    definitionBlock: 'Una canción de San Valentín personalizada es el regalo romántico perfecto para el 14 de febrero, creado con IA. Incluye los nombres de la pareja y un mensaje de amor único, en bachata, bolero o balada. Más especial que flores o chocolates, lista en minutos desde $24.99.',
    icon: '❤️',
    color: '#E11D48',
  ...
  'navidad': {
    ...
    definitionBlock: 'Una canción navideña personalizada es un villancico único creado con IA que menciona los nombres de toda la familia. En cumbia, pop latino, mariachi o balada, es el regalo de Navidad que guardarán para siempre y podrán escuchar cada diciembre. Desde $24.99.',
    icon: '🎄',
    color: '#15803D',
  ...
  'declaracion-amor': {
    ...
    definitionBlock: 'Una canción para declarar tu amor es una pieza musical romántica creada con IA que expresa tus sentimientos con el nombre de esa persona especial. En bachata, bolero, balada o mariachi, dice todo lo que tu corazón no puede expresar. Lista en minutos desde $24.99.',
    icon: '💌',
    color: '#DB2777',
  ...
  'despedida': {
    ...
    definitionBlock: 'Una canción de despedida personalizada es un regalo musical emotivo creado con IA que expresa todo lo que esa persona significa para ti. Para jubilaciones, mudanzas o adioses, en bolero, balada o norteño, incluye su nombre y un mensaje del corazón. Desde $24.99.',
    icon: '👋',
    color: '#64748B',
  ...
  'agradecimiento': {
    ...
    definitionBlock: 'Una canción de agradecimiento personalizada es un regalo musical creado con IA que expresa tu gratitud de forma inolvidable. Incluye el nombre de esa persona especial — maestro, mentor o amigo — y un mensaje de agradecimiento en bolero, balada, mariachi o cumbia. Desde $24.99.',
    icon: '🙏',
    color: '#0891B2',
