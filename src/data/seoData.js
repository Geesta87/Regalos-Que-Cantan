...
export const GENRES_SEO = {
  'corridos-tumbados': {
    ...
    metaDescription: 'Crea un corrido tumbado personalizado único. Estilo Peso Pluma, Junior H, Natanael Cano. Letra con el nombre de tu ser querido. Listo en minutos desde $29.99.',
    ...
    definitionBlock: 'Un corrido tumbado personalizado es una canción original que fusiona corrido mexicano con trap y hip-hop, creada exclusivamente para incluir el nombre y la historia de tu ser querido. Con el flow de artistas como Peso Pluma y Junior H, es un regalo único listo en minutos desde $29.99.',
...
Perfecto para cumpleaños, graduaciones, o simplemente para sorprender a alguien especial con un regalo que nunca olvidarán.`,
  ...
  'corrido-clasico': {
    ...
    metaDescription: 'Crea un corrido clásico tradicional personalizado. Estilo Los Tigres del Norte, Los Tucanes. Historia de vida en canción. Desde $29.99.',
...
Con RegalosQueCantan, puedes crear un corrido clásico que cuente la historia de alguien especial. Ya sea su trayectoria de vida, sus logros, o simplemente lo mucho que significa para ti, creamos letras narrativas en el estilo tradicional del corrido.`,
  ...
  'banda-sinaloense': {
    ...
    metaDescription: 'Crea una canción de banda sinaloense personalizada. Estilo Banda MS, El Recodo, Julión Álvarez. Con metales, tuba y nombre personalizado. Desde $29.99.',
...
Crea una canción norteña personalizada que incluya el nombre de tu ser querido y un mensaje especial. Ya sea una canción de amor, de amistad, o de celebración, capturamos la esencia del género norteño.`,
  ...
  'cumbia': {
    ...
    metaDescription: 'Crea una cumbia personalizada. Ritmo contagioso, güiro y acordeón. Perfecta para fiestas y celebraciones. Desde $29.99.',
...
Tu cumbia personalizada incluirá el nombre de tu ser querido, un mensaje especial, y ese ritmo contagioso que no deja a nadie quieto. Perfecta para cualquier celebración donde quieras que todos bailen y celebren.`,
  ...
  'cumbia-colombiana': {
    ...
    metaDescription: 'Crea una cumbia colombiana tradicional personalizada. El ritmo original de Colombia con tu mensaje especial. Desde $29.99.',
  ...
  'cumbia-texana': {
    ...
    metaDescription: 'Crea una cumbia texana personalizada. El sonido de Texas con teclados y ritmo único. Desde $29.99.',
  ...
  'mariachi': {
    ...
    metaDescription: 'Crea una canción de mariachi personalizada. Trompetas, violines y guitarrón con el nombre de tu ser querido. Serenata perfecta desde $29.99.',
...
Una serenata de mariachi es el regalo más romántico y tradicional. Con RegalosQueCantan, puedes crear una canción de mariachi personalizada que incluya el nombre de tu amor, un mensaje especial, y toda la emoción del género.`,
  ...
  'bachata': {
    ...
    metaDescription: 'Crea una bachata romántica personalizada. Estilo Romeo Santos, Prince Royce. Guitarra y ritmo sensual con tu mensaje de amor. Desde $29.99.',
...
Una bachata personalizada es el regalo perfecto para esa persona especial. Incluye su nombre, menciona momentos especiales de su relación, y créale una canción de amor que nunca olvidará.`,
  ...
  'reggaeton': {
    ...
    metaDescription: 'Crea un reggaeton personalizado. Perreo, dembow y letras únicas con el nombre de tu persona especial. Desde $29.99.',
  ...
  'salsa': {
    ...
    metaDescription: 'Crea una salsa personalizada. Trompetas, piano y sabor caribeño. Estilo Marc Anthony, Héctor Lavoe. Desde $29.99.',
    ...
    definitionBlock: 'Una salsa personalizada es una canción caribeña original con trompetas, piano y timbales, creada exclusivamente al estilo de Marc Anthony y Héctor Lavoe. Incluye el nombre de tu ser querido y un mensaje especial, perfecta para bodas, aniversarios y fiestas. Lista en minutos desde $29.99.',
  ...
  'bolero': {
    ...
    metaDescription: 'Crea un bolero romántico personalizado. El género más romántico con guitarras y letras poéticas. Desde $29.99.',
  ...
  'ranchera': {
    ...
    metaDescription: 'Crea una ranchera personalizada. El género tradicional mexicano con mariachi. Estilo José Alfredo Jiménez. Desde $29.99.',
  ...
  'regional-mexicano': {
    ...
    metaDescription: 'Crea una canción de regional mexicano personalizada. Mezcla de géneros tradicionales mexicanos. Desde $29.99.',
  ...
  'pop-latino': {
    ...
    metaDescription: 'Crea una canción de pop latino personalizada. Estilo Luis Fonsi, Shakira. Moderno y pegajoso. Desde $29.99.',
    ...
    definitionBlock: 'Una canción de pop latino personalizada combina ritmos latinos con producción moderna, creada exclusivamente al estilo de Shakira y Luis Fonsi. Pegajosa y bailable, incluye el nombre de tu ser querido con un mensaje especial. Ideal para cumpleaños, graduaciones y quinceañeras. Desde $29.99.',
  ...
  'balada': {
    ...
    metaDescription: 'Crea una balada romántica personalizada. Letras emotivas y melodías que llegan al corazón. Desde $29.99.',
  ...
  'vallenato': {
    ...
    metaDescription: 'Crea un vallenato personalizado. Acordeón, caja y guacharaca. El sonido de Colombia con tu mensaje. Desde $29.99.',
  ...
  'merengue': {
    ...
    metaDescription: 'Crea un merengue personalizado. El ritmo más rápido y alegre del Caribe con tu mensaje especial. Desde $29.99.',
    ...
    definitionBlock: 'Un merengue personalizado es una canción dominicana rápida y alegre con acordeón, güira y tambora, creada exclusivamente al estilo de Juan Luis Guerra y Los Hermanos Rosario. Incluye el nombre de tu ser querido para una celebración llena de energía. Perfecta para fiestas y cumpleaños. Desde $29.99.',
  ...
  'huapango': {
    ...
    metaDescription: 'Crea un huapango personalizado. El son huasteco con violín, jarana y guitarra quinta. Tradición mexicana. Desde $29.99.',
  ...
  'son-jarocho': {
    ...
    metaDescription: 'Crea un son jarocho personalizado. La música tradicional de Veracruz con arpa, jarana y requinto. Desde $29.99.',
...
Ya sea mariachi tradicional, bolero romántico, o el género que ella prefiera, creamos la canción perfecta para tu mamá.`,
  ...
  'dia-del-padre': {
    ...
    definitionBlock: 'Una canción para el Día del Padre personalizada es un regalo musical creado exclusivamente que menciona el nombre de papá, sus logros y tu agradecimiento. En corrido, norteño, banda o el género que él prefiera, es la sorpresa que papá nunca esperaría. Lista en minutos desde $29.99.',
...
Crea un corrido que cuente sus logros, una ranchera que exprese tu admiración, o una banda que lo haga sonreír. El género que él prefiera, con su nombre y un mensaje de tu corazón.`,
  ...
  'aniversario': {
    ...
    definitionBlock: 'Una canción de aniversario personalizada es un regalo romántico creado exclusivamente que cuenta la historia de amor de la pareja. Incluye los nombres de ambos, cómo se conocieron y promesas de amor, en bachata, bolero o el género que defina su relación. Lista en minutos desde $29.99.',
...
En bachata romántica, bolero clásico, o el género que marque su relación.`,
  ...
  'boda': {
    ...
    definitionBlock: 'Una canción de boda personalizada es una pieza musical única creada exclusivamente para el primer baile de los novios. Incluye los nombres de la pareja y su historia de amor, en bachata, bolero, cumbia o vals. Es el primer baile que ninguna otra pareja tendrá. Lista en minutos desde $29.99.',
...
Ya sea un vals romántico, una cumbia para que todos bailen, o una bachata sensual — la canción será solo suya.`,
  ...
  'quinceanera': {
    ...
    definitionBlock: 'Una canción de quinceañera personalizada es un vals único creado exclusivamente que incluye el nombre de la festejada y deseos especiales para su nueva etapa. Disponible en balada, bachata, cumbia o mariachi, es el regalo perfecto para los XV años que ella nunca olvidará. Desde $29.99.',
...
Puede ser un vals tradicional, una cumbia para después, o incluso un reggaeton para la fiesta. Todo personalizado para ella.`,
  ...
  'declaracion-amor': {
    ...
    title: 'Canciones para Regalar: Declara tu Amor con una Canción',
    metaDescription: 'La canción perfecta para regalar: personalizada con su nombre y tu historia. Bachata, bolero o balada, lista en minutos. Desde $29.99.',
    keywords: 'canciones para regalar, canción para regalar, regalar una canción, declaración de amor, canción para enamorar, canción romántica personalizada',
    ...
    definitionBlock: 'De todas las canciones para regalar, ninguna se compara con una creada exclusivamente para esa persona: una pieza musical romántica con su nombre y tu historia. En bachata, bolero, balada o mariachi, dice todo lo que tu corazón no puede expresar. Lista en minutos desde $29.99.',
    icon: '💌',
    color: '#DB2777',
  ...
  'agradecimiento': {
    ...
    definitionBlock: 'Una canción de agradecimiento personalizada es un regalo musical creado exclusivamente que expresa tu gratitud de forma inolvidable. Incluye el nombre de esa persona especial — maestro, mentor o amigo — y un mensaje de agradecimiento en bolero, balada, mariachi o cumbia. Desde $29.99.',
    icon: '🙏',
    color: '#0891B2',
