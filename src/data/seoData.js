...
Puede ser un vals tradicional, una cumbia para después, o incluso un reggaeton para la fiesta. Todo personalizado para ella.`,
  ...
  'declaracion-amor': {
    ...
    definitionBlock: 'Una canción para declarar tu amor es una pieza musical romántica creada exclusivamente que expresa tus sentimientos con el nombre de esa persona especial. En bachata, bolero, balada o mariachi, dice todo lo que tu corazón no puede expresar. Lista en minutos desde $29.99.',
    icon: '💌',
    color: '#DB2777',
