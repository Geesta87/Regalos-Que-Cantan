                          ...
                          <td className="px-4 py-3">
                            <div className="flex items-center justify-center gap-1">
                              ...
                              {/* WhatsApp send button — visible whenever the customer left a
                                  ...
                                  Sized identically to the other action icons (p-2 + 20px
                                  glyph) and filled with the official WhatsApp green so it
                                  reads as a WhatsApp button, not an email button. */}
                              {song.whatsapp_phone && song.audio_url && (() => {
                                ...
                                return (
                                  ...
                                  >
                                    {/* Inline WhatsApp glyph — recognizable shape, scales
                                        cleanly, no font-loading dependency. */}
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="20"
                                      height="20"
                                      viewBox="0 0 24 24"
                                      fill={alreadySent ? '#9ca3af' : '#ffffff'}
                                      aria-hidden="true"
                                    >
