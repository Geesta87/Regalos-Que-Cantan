 ...
 *
 * Design uses the real brand system: bougainvillea #f20d80 on warm near-black
 * (landing-bg #181114), Playfair Display headings (font-display), glass-morphism
    ...
    >
      ...
      {!playing && (
        <div className="absolute inset-0 bg-black/30 group-hover:bg-black/20 transition-colors flex items-center justify-center">
          <div className="w-14 h-14 rounded-full flex items-center justify-center" style={{ background: '#f20d80', boxShadow: '0 0 24px rgba(242,13,128,0.5)' }}>
...
export default function CancionesParaRegalarLanding() {
  ...
  const ctaStyle = { background: 'linear-gradient(135deg, #f20d80, #c00a66)', boxShadow: '0 0 24px rgba(242,13,128,0.45)' };
      ...
      <div className="min-h-screen bg-landing-bg text-white font-body overflow-x-hidden">
        ...
        <section className="relative px-6 pt-14 pb-20 md:pt-20 md:pb-28 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <div className="absolute left-1/2 top-[-10%] -translate-x-1/2 w-[680px] h-[680px] rounded-full blur-[130px]" style={{ background: 'rgba(242,13,128,0.16)' }} />
          </div>
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <nav className="mb-8" aria-label="Breadcrumb">
              <ol className="flex items-center justify-center gap-2 text-xs text-white/40">
            ...
            <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 mb-7 border" style={{ background: 'rgba(242,13,128,0.10)', borderColor: 'rgba(242,13,128,0.25)' }}>
            ...
            <h1 className="font-display text-4xl md:text-6xl lg:text-[4.25rem] font-black leading-[1.05] tracking-tight mb-6">
              ...
              <span className="block mt-2 text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(100deg,#ff5cb0,#f20d80 55%,#ffb3d9)' }}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mt-7 text-sm text-white/45">
              ...
              {SAMPLES.map((s) => {
                ...
                return (
                  <div
                    ...
                    style={isPlaying ? { borderColor: 'rgba(242,13,128,0.6)', background: 'rgba(242,13,128,0.09)' } : undefined}
                  >
                    <div className="p-5">
                      <div className="flex items-center gap-4">
                        <button
                          ...
                          style={isPlaying
                            ? { background: '#f20d80', transform: 'scale(1.08)', boxShadow: '0 0 22px rgba(242,13,128,0.55)' }
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-white/45 text-xs mt-0.5 truncate">{s.tag}</p>
                        </div>
                      </div>
                      <div className="mt-4 flex items-center gap-2">
                        <div className="flex-1 h-1.5 bg-white/10 rounded-full overflow-hidden">
                          <div className="h-full rounded-full transition-all duration-200" style={{ width: `${pct}%`, background: '#f20d80' }} />
                        </div>
                    ...
                    {isPlaying && (
                      <div className="px-5 py-2 flex items-center gap-2 border-t" style={{ background: 'rgba(242,13,128,0.10)', borderColor: 'rgba(242,13,128,0.20)' }}>
                        <span className="w-2 h-2 rounded-full animate-pulse" style={{ background: '#f20d80' }} />
        ...
        <section className="px-6 pb-20">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-center text-white/25 text-xs mt-4 md:hidden">Desliza para ver más →</p>
          </div>
        </section>
              ...
              {STEPS.map((s) => (
                <div key={s.n} className="text-center">
                  <div className="w-14 h-14 rounded-full flex items-center justify-center text-xl font-black mx-auto mb-4 text-white"
                    style={{ background: 'linear-gradient(135deg,#f20d80,#c00a66)', boxShadow: '0 0 18px rgba(242,13,128,0.35)' }}>
                    {s.n}
                  </div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                <div key={c.t} className="glass-morphism rounded-2xl p-6">
                  <span className="material-symbols-outlined text-3xl mb-3 block" style={{ color: '#f20d80', fontVariationSettings: "'FILL' 1" }}>{c.icon}</span>
                  <h3 className="font-bold text-white mb-2">{c.t}</h3>
                  <p className="text-white/50 text-sm leading-relaxed">{c.d}</p>
                </div>
              ))}
            </div>
            <p className="text-white/45 text-center text-sm leading-relaxed max-w-2xl mx-auto mt-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {popularGenres.map((g) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center text-2xl shrink-0" style={{ background: 'rgba(242,13,128,0.10)', border: '1px solid rgba(242,13,128,0.22)' }}>
                    {g.icon}
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-white transition-colors">{g.name}</h3>
                    <p className="text-xs text-white/40 line-clamp-2 mt-0.5">{g.description}</p>
                  </div>
                  <span className="material-symbols-outlined text-white/25 group-hover:text-white/60 group-hover:translate-x-0.5 transition-all shrink-0">chevron_right</span>
                </SEOLink>
              ))}
            </div>
        ...
        <section className="px-6 pb-20">
          <div className="max-w-lg mx-auto text-center">
            <div className="rounded-3xl p-9 border" style={{ background: 'linear-gradient(180deg, rgba(242,13,128,0.10), rgba(255,255,255,0.02))', borderColor: 'rgba(242,13,128,0.22)' }}>
              <p className="uppercase tracking-[0.22em] text-[11px] font-bold text-white/40 mb-3">Pago único · Sin suscripción</p>
              <div className="font-display text-5xl md:text-6xl font-black mb-2">$29.99</div>
              <p className="text-white/45 text-sm mb-8">2 versiones únicas · Descarga MP3 · Tuya para siempre</p>
              <button onClick={() => handleCreateSong()} style={ctaStyle}
              ...
              <p className="text-white/30 text-xs mt-4">🔒 Pago seguro · La escuchas antes de pagar</p>
            </div>
          </div>
        </section>
                ...
                return (
                  <div key={i} className="rounded-2xl overflow-hidden border border-white/10">
                    ...
                    >
                      ...
                      <span className={`material-symbols-outlined shrink-0 transition-transform ${open ? 'rotate-180' : ''}`} style={{ color: '#f20d80' }}>expand_more</span>
                    </button>
        ...
        <section className="relative px-6 pb-24 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute left-1/2 bottom-0 -translate-x-1/2 w-[560px] h-[380px] rounded-full blur-[120px]" style={{ background: 'rgba(242,13,128,0.13)' }} />
          </div>
        ...
        <footer className="py-10 px-6 border-t border-white/5 text-center">
          <p className="text-white/25 text-sm">© {new Date().getFullYear()} RegalosQueCantan. Todos los derechos reservados.</p>
