    ...
    >
      ...
      {!playing && (
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <div className="w-16 h-16 bg-blue-500/90 rounded-full flex items-center justify-center shadow-xl shadow-blue-500/30">
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden">
        ...
        {/* ─── URGENCY BAR ─── */}
        <div className="bg-gradient-to-r from-blue-600 via-indigo-500 to-blue-600 text-white text-center py-2.5 px-4 font-bold text-sm sticky top-0 z-50">
        ...
        <section className="relative px-6 pt-16 pb-20 md:pt-24 md:pb-28 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-5 py-2 mb-8">
              <span className="text-blue-300 text-sm font-bold">&#129312; Dia del Padre 2026</span>
            </div>

            {/* Headline */}
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-[0.95] tracking-tight mb-6">
              No le regales{' '}
              <span className="bg-gradient-to-r from-blue-400 via-indigo-300 to-blue-300 bg-clip-text text-transparent">
                corbata otra vez
              </span>
            </h1>
            ...
            <button
              ...
              className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-400 hover:to-indigo-400 text-white font-extrabold text-lg md:text-xl px-10 py-5 rounded-full transition-all duration-300 hover:scale-105 active:scale-95"
            ...
            <p className="mt-8 text-white/20 text-sm">
              <span className="text-blue-300 font-bold">927+</span> canciones creadas para papa este mes
            </p>
          </div>
        </section>
        ...
        <section className="px-6 pb-20">
          <div className="max-w-xl mx-auto text-center">
            <div className="bg-gradient-to-b from-white/[0.04] to-transparent border border-white/10 rounded-3xl p-10">
              ...
              <button
                onClick={handleCreateSong}
                className="w-full inline-flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-400 hover:to-indigo-400 text-white font-extrabold text-lg px-8 py-5 rounded-full transition-all duration-300 hover:scale-[1.02] active:scale-95"
                style={{ animation: 'ctaGlowPadre 2s ease-in-out infinite' }}
              >
        ...
        <section className="px-6 pb-16">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <button
              onClick={handleCreateSong}
              className="inline-flex items-center gap-2 bg-white/10 hover:bg-blue-500/20 border border-white/10 hover:border-blue-500/30 text-white font-bold px-8 py-4 rounded-full transition-all text-sm"
            >
