...
/**
 * DiaDelPadreLanding - Modern, urgency-driven Father's Day landing page
 * Cloned from DiaDeLasMadresLanding with blue/indigo theme and papá-specific copy.
 * Target date: 21 de Junio 2026 (third Sunday of June — Día del Padre in US & MX).
 */
    ...
    >
      ...
      {!playing && (
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <div className="w-16 h-16 bg-anil/90 rounded-full flex items-center justify-center shadow-xl shadow-anil/30">
...
function CountdownTimer() {
  ...
  useEffect(() => {
    // Día del Padre 2026 — Sunday, June 21 (third Sunday of June, US & MX)
    const targetDate = new Date('2026-06-21T00:00:00-06:00');
    const update = () => {
      const now = new Date();
...
export default function DiaDelPadreLanding() {
  const { navigateTo, setFormData } = useContext(AppContext);

  const handleCreateSong = () => {
    setFormData(prev => ({
      ...prev,
      occasion: 'dia-del-padre',
      occasionName: 'Dia del Padre'
    }));
    navigateTo('genre');
  };
  ...
  const breadcrumbs = [
    { name: 'Inicio', path: '/' },
    { name: 'Dia del Padre', path: '/dia-del-padre' }
  ];
  ...
  const faqs = [
    ...
    { question: 'Cuanto cuesta la cancion para papa?', answer: 'Una cancion individual cuesta $29.99 USD. Pago unico. Recibes 2 versiones para elegir tu favorita.' },
  ];
  ...
  return (
    <>
      <SEOHead
        title="Cancion para Papa | Dia del Padre 2026 | RegalosQueCantan"
        description="Sorprende a papa con una cancion personalizada este Dia del Padre. Con su nombre, en corrido, norteño o banda. Lista en minutos desde $29.99."
        canonical="/dia-del-padre"
      ...
      <div className="min-h-screen bg-[#191A45] text-white overflow-x-hidden">
        ...
        {/* ─── URGENCY BAR ─── */}
        <div className="bg-gradient-to-r from-anil-deep via-anil to-anil-deep text-white text-center py-2.5 px-4 font-bold text-sm sticky top-0 z-50">
          <span className="animate-pulse inline-block mr-1">&#10071;</span>
          El 21 de Junio se acerca — No te quedes sin el regalo perfecto para papa
        ...
        <section className="relative px-6 pt-16 pb-20 md:pt-24 md:pb-28 overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-anil/10 rounded-full blur-[120px]"></div>
          </div>
          ...
          <div className="absolute inset-0 z-0 pointer-events-none select-none overflow-hidden opacity-30 md:opacity-40">
            {[
              { src: '/images/reactions/papa/papa-1.png', style: 'top-[5%] left-[-4%] md:left-[2%] w-36 md:w-52 rotate-[-8deg]' },
              { src: '/images/reactions/papa/papa-4.png', style: 'top-[8%] right-[-4%] md:right-[2%] w-32 md:w-48 rotate-[6deg]' },
              { src: '/images/reactions/papa/papa-5.png', style: 'bottom-[6%] left-[50%] -translate-x-1/2 w-36 md:w-52 rotate-[3deg]' },
            ].map((photo, i) => (
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-anil/10 border border-anil/20 rounded-full px-5 py-2 mb-8">
              <span className="text-anil-soft text-sm font-bold">&#129312; Dia del Padre 2026</span>
            </div>

            {/* Headline */}
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-[0.95] tracking-tight mb-6">
              No le regales{' '}
              <span className="bg-gradient-to-r from-anil via-indigo-300 to-anil-soft bg-clip-text text-transparent">
                corbata otra vez
              </span>
            </h1>
            ...
            <p className="text-lg md:text-xl text-white/50 max-w-xl mx-auto mb-8 leading-relaxed">
              Este 21 de Junio, regalale algo que nunca ha recibido.
              <br className="hidden md:block" />
              Un corrido con su nombre, unico en el mundo.
            </p>
            ...
            <button
              ...
              className="inline-flex items-center gap-3 bg-gradient-to-r from-anil to-anil hover:from-anil hover:to-anil text-white font-extrabold text-lg md:text-xl px-10 py-5 rounded-full transition-all duration-300 hover:scale-105 active:scale-95"
              style={{ animation: 'ctaGlowPadre 2s ease-in-out infinite' }}
            >
              <span className="text-2xl">&#127908;</span>
              Crear la Cancion para Papa
            </button>
            ...
            <p className="mt-8 text-white/55 text-sm">
              <span className="text-anil-soft font-bold">927+</span> canciones creadas para papa este mes
            </p>
          </div>
        </section>
        ...
        <section className="px-6 pb-20">
          <div className="max-w-xl mx-auto text-center">
            <div className="bg-gradient-to-b from-white/[0.04] to-transparent border border-white/10 rounded-3xl p-10">
              ...
              <button
                onClick={handleCreateSong}
                className="w-full inline-flex items-center justify-center gap-3 bg-gradient-to-r from-anil to-anil hover:from-anil hover:to-anil text-white font-extrabold text-lg px-8 py-5 rounded-full transition-all duration-300 hover:scale-[1.02] active:scale-95"
                style={{ animation: 'ctaGlowPadre 2s ease-in-out infinite' }}
              >
                <span className="text-xl">&#129312;</span>
                Sorprender a Papa Ahora
              </button>
        ...
        <section className="px-6 pb-16">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <button
              onClick={handleCreateSong}
              className="inline-flex items-center gap-2 bg-white/10 hover:bg-anil/20 border border-white/10 hover:border-anil/30 text-white font-bold px-8 py-4 rounded-full transition-all text-sm"
            >
              &#127908; Crear Cancion para Papa — $29.99
            </button>
          </div>
        </section>
