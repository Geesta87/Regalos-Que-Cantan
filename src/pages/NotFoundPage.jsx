  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#F9F6F2] flex flex-col items-center justify-center px-6 text-center">
        ...
        <h1 className="text-4xl font-bold text-[#1A4338] mb-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <SEOLink
            to="landing"
            className="px-8 py-3 bg-[#1A4338] text-white rounded-full font-bold hover:bg-[#2D5A4A] transition-colors"
          >
            Ir al Inicio
          </SEOLink>
          <SEOLink
            to="generos"
            className="px-8 py-3 border-2 border-[#1A4338] text-[#1A4338] rounded-full font-bold hover:bg-[#1A4338]/5 transition-colors"
          >
            Ver Géneros
          </SEOLink>
          <SEOLink
